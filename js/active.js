...
// open header ul 
let header_mnu = document.querySelector("header .link ul ");
let headerMenu = document.querySelector(".cart_header .header_list i");
// headerMenu.onclick = ()=>{
//     header_mnu.classList.toggle("activeMenu");
//     console.log(header_mnu.classList)
// }
...
// //////////////////////////////////////////////////////////////////////////////////////
// var moreCard = [];
// function addToCartMore(index , btn){
//     moreCard.push(all_products_json[index]);
//     btn.classList.add('active');
//     getCartItem3();
// }
// // for the under slide has no image
// function getCartItem3(){
//     let total_price = 0;
//     let item_c = '' ;
//     for(i=0 ; i < moreCard.length; i++){
//         item_c += `
//         <div class="item_cart">
//             <img src="${moreCard[i].img}" alt="">

//             <div class="content">
//                 <h4>${moreCard[i].name}</h4>
//                 <div class="price_cart">$${moreCard[i].thePrice}</div>
//             </div>

//             <button onclick='remove_from_cart(${i})' class="delete_item"><i class="fa-solid fa-trash"></i></button>
//         </div>
//         `
//         total_price += moreCard[i].thePrice;
//     }
//     items_in_cart.innerHTML = item_c ; 

//     price_cart_head.innerHTML = total_price;
//     count_item.innerHTML = moreCard.length ;

//     count_item_cart.innerHTML =`${moreCard.length}`;
//     price_cart_total.innerHTML = "$" + total_price;
//     cart.classList.add('active');
// }
// /////////////////////////////////////////////////////////////////////////////////////
